...
namespace apiDiabetes.Controllers
{
    ...
    public class ElementosController : ControllerBase
    {
        ...
        public ElementosController(dbDiabetesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostElementos([FromBody] Elementos elementos)
        {
            ...
            return CreatedAtAction("GetElementos", new { id = elementos.IdElementos }, elementos);
        }
        ...
        {
            return _context.Elementos.Any(e => e.IdElementos == id);
        }
    }
}